...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "ud8df669ca1df692811df130505950b50")
                elif text.lower() == 'มิด':
...
#==============================================================================#
        ...
        if op.type == 17:
        	...
        	line.sendMessage(op.param1, "สวัสดี {}, Welcome to Group {}\nยินดีต้อนรับครับบ・ω・".format(str(dan.displayName),str(tgb.name)))
